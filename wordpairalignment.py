# -*- coding: utf-8 -*-
import re
"""WordPairAlignment.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1eFJRcPJo4jYXLKB7O73ZhMoHHUc5f1Y4
"""
...
def lcs(s1,s2):
    ...
    i = 0
    for x in s1:
        if re.search(re.escape(x), s2):
          s = x
          while re.search(re.escape(s), s2):
...
def iterLCS(pdf):
    ...
    while True:
        ...
        tempSInd =  pdf['source'].find(tempVal) + 1
        tempTInd =  pdf['target'].find(tempVal) + 1
        if (tempSInd - prevSInd)*(tempTInd - prevTInd) < 0:
            print('here',tempVal,pdf['source'],pdf['target'])
...
# use iterLCS as a pandas apply method
# You must have a pandas dataframe as input
# The dataframe should contain columns 'source' and 'target'
